...
public class PrimGeneratorTest extends GeneratorTest {

    @DisplayName("Тест PrimeGenerator#generate на создание проходимого лабиринта")
    @ParameterizedTest(name = "{0} {1} - лабиринт проходим")
    @MethodSource("sizes")
    public void generate_shouldReturnCorrectMaze(int width, int height) {
        Maze maze = new PrimGenerator().generate(width, height);
